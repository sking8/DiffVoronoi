...
public:
	...
	void Initialize(const T_SPARSE& _A,const Vector<int,d>& counts,const MultiGrid::Params _params= MultiGrid::Params(),const Field<short,d>* material_id=nullptr);
...
{public:
	...
	MultiGrid::Params params;

	KrylovPreGMG(const KA* _ka,const Vector<int,d>& _counts,const MultiGrid::Params& _params,const Field<short,d>* mat_id=nullptr)
