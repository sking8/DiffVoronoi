...
public:
	...
	using Base::mac_grid;
	using Base::matrix_to_grid;
	using Base::velocity;
	using Base::div_u;
	using Base::bc;
	using Base::p;
	using Base::is_A_initialized;
	using Base::update_A;
	using Base::grid_to_matrix;
	using Base::A;
	using Base::verbose;
	using Base::solver_mode;
	using Base::Prepare_CPX_System;
	using Base::Is_Fluid_Cell;
	using Base::Is_Valid_Cell;
	using Base::Allocate_System;
	using Base::Update_A;
	using Base::Correction;
	...
	virtual real Velocity_Correction(const int& axis, const VectorDi& face)const;
