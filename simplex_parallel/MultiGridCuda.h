...
////CG
template<class MtxT, class T> int Preconditioned_Conjugate_Gradient(MtxT* A_host, T* _b, T* _x, int iter_num, T tolerance, bool use_precond = true);
template<class MtxT, class T> int Preconditioned_Conjugate_Gradient_Device(MtxT* A_dev, T* b, T* x, T* r, T* d, T* q, T* s, T* pd, int iter_num, T tolerance, bool use_precond=true);
